...
<head>
    ...
    <link href="<c:url value= "main/resources/static/css/bootstrap.css"/>"
          rel="stylesheet">
    <style type="text/css">
        body {
            padding-top: 20px;
    ...
    <link href="<c:url value="main/resources/static/css/bootstrap-responsive.css" />"
          rel="stylesheet">
</head>
<body>
<div class="container-narrow">
    ...
    <c:if test="${not empty allPostFromUser}">
        <c:forEach items="${allPostFromUser}" var="singlePost">
            <h2>
                <a href="<c:url value="main/resources/templates/post.jsp"/>/<c:out value="${singlePost.id}"/>">${singlePost.title}</a>
            </h2>
