...
<head>
    ...
    <link href="<c:url value="main/resources/static/css/bootstrap.css" />" rel="stylesheet">
    <style type="text/css">
        body {
            padding-top: 40px;
            padding-bottom: 40px;
    ...
    <link href="<c:url value="main/resources/static/css/bootstrap-responsive.css" />" rel="stylesheet">
</head>
<body>
<div class="container">
    <%--@elvariable id="loginUser" type="java"--%>
